...
b.prototype.R=function(g){if(g===this)this.A(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.ea(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.L(g):this.m(g)}};
...
b.prototype.then=function(g,h){function k(r,p){return"function"==typeof r?function(z){try{l(r(z))}catch(G){n(G)}}:p}
...
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,n){function q(z){return function(G){r[z]=G;p--;0==p&&l(r)}}
...
c.prototype=b.prototype;a.O=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.xm=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var Tb={};function Ub(a,b,c){this.h=c===Tb?a:"";this.i=b;this.V=this.Fa=!0}
...
function b(q){for(var r=g,p=0;64>p;p+=4)r[p/4]=q[p]<<24|q[p+1]<<16|q[p+2]<<8|q[p+3];for(p=16;80>p;p++)q=r[p-3]^r[p-8]^r[p-14]^r[p-16],r[p]=(q<<1|q>>>31)&4294967295;q=e[0];var z=e[1],G=e[2],H=e[3],R=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var V=H^z&(G^H);var K=1518500249}else V=z^G^H,K=1859775393;else 60>p?(V=z&G|H&(z|G),K=2400959708):(V=z^G^H,K=3395469782);V=((q<<5|q>>>27)&4294967295)+V+R+K+r[p]&4294967295;R=H;H=G;G=(z<<30|z>>>2)&4294967295;z=q;q=V}e[0]=e[0]+q&4294967295;e[1]=e[1]+z&4294967295;e[2]=
e[2]+G&4294967295;e[3]=e[3]+H&4294967295;e[4]=e[4]+R&4294967295}
function c(q,r){if("string"===typeof q){q=unescape(encodeURIComponent(q));for(var p=[],z=0,G=q.length;z<G;++z)p.push(q.charCodeAt(z));q=p}r||(r=q.length);p=0;if(0==l)for(;p+64<r;)b(q.slice(p,p+64)),p+=64,n+=64;for(;p<r;)if(f[l++]=q[p++],n++,64==l)for(l=0,b(f);p+64<r;)b(q.slice(p,p+64)),p+=64,n+=64}
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Fm;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Ha}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
;function eg(a){this.C=a;this.i=null;this.m=0;this.B=null;this.o=0;this.j=[];for(a=0;4>a;a++)this.j.push(0);this.l=0;this.L=$f(window,"mousemove",Pa(this.R,this));a=Pa(this.I,this);"function"===typeof a&&(a=Lf(a));this.S=window.setInterval(a,25)}
...
eg.prototype.D=function(){window.clearInterval(this.S);ag(this.L)};function fg(){}
...
function ng(a){var b=void 0===a?{}:a;a=void 0===b.Hb?!1:b.Hb;b=void 0===b.sb?!0:b.sb;if(null==B("_lact",window)){var c=parseInt(E("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;A("_lact",c,window);A("_fact",c,window);-1==c&&og();$f(document,"keydown",og);$f(document,"keyup",og);$f(document,"mousedown",og);$f(document,"mouseup",og);a?$f(window,"touchmove",function(){pg("touchmove",200)},{passive:!0}):($f(window,"resize",function(){pg("resize",200)}),b&&$f(window,"scroll",function(){pg("scroll",200)}));
...
;function Eg(a){var b=Fg;a=void 0===a?B("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=gd;e.flash="0";a:{try{var f=b.h.top.location.href}catch(La){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);try{e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?J:g;try{var h=g.history.length}catch(La){h=0}e.u_his=h;J.screen&&(e.u_h=J.screen.height,e.u_w=J.screen.width,e.u_ah=J.screen.availHeight,e.u_aw=J.screen.availWidth,e.u_cd=J.screen.colorDepth);e.u_java=!!J.navigator&&"unknown"!==
typeof J.navigator.javaEnabled&&!!J.navigator.javaEnabled&&J.navigator.javaEnabled();J.navigator&&J.navigator.plugins&&(e.u_nplug=J.navigator.plugins.length);J.navigator&&J.navigator.mimeTypes&&(e.u_nmime=J.navigator.mimeTypes.length)}catch(La){}h=b.h;try{var k=h.screenX;var l=h.screenY}catch(La){}try{var n=h.outerWidth;var q=h.outerHeight}catch(La){}try{var r=h.innerWidth;var p=h.innerHeight}catch(La){}try{var z=h.screenLeft;var G=h.screenTop}catch(La){}try{r=h.innerWidth,p=h.innerHeight}catch(La){}try{var H=
h.screen.availWidth;var R=h.screen.availTop}catch(La){}k=[z,G,k,l,H,R,n,q,r,p];l=b.h.top;try{var V=(l||window).document,K="CSS1Compat"==V.compatMode?V.documentElement:V.body;var U=(new Qc(K.clientWidth,K.clientHeight)).round()}catch(La){U=new Qc(-12245933,-12245933)}V=U;U={};K=new td;y.SVGElement&&y.document.createElementNS&&K.set(0);l=bd();l["allow-top-navigation-by-user-activation"]&&K.set(1);l["allow-popups-to-escape-sandbox"]&&K.set(2);y.crypto&&y.crypto.subtle&&K.set(3);y.TextDecoder&&y.TextEncoder&&
...
A("yt.ads_.signals_.getAdSignalsString",function(a){return zg(Eg(a))},void 0);Date.now();var Gg="XMLHttpRequest"in y?function(){return new XMLHttpRequest}:null;
...
" "))}k="1"!==p}f=!k;break b}}catch(G){}f=!1}f?ah(a)?(b&&b(),f=!0):f=!1:f=!1;f||bh(a,b)}}
...
;var Ih=y.ytLoggingGelSequenceIdObj_||{};A("ytLoggingGelSequenceIdObj_",Ih,void 0);
function Jh(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=qg();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};O("log_sequence_info_on_gel_web")&&d.Z&&(a=e.context,b=d.Z,Ih[b]=b in Ih?Ih[b]+1:0,a.sequence={index:Ih[b],groupKey:b},d.tb&&delete Ih[d.Z]);(d.Gm?Bh:xh)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,ra:d.ra},c)}
...
function Vh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||E("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.wm||E("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().vm:b=sd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=E("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=E("DELEGATED_SESSION_ID")));return d}
...
di.prototype.toString=function(){return this.topic};var ei=B("ytPubsub2Pubsub2Instance")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.ia;M.prototype.publish=M.prototype.ba;M.prototype.clear=M.prototype.clear;A("ytPubsub2Pubsub2Instance",ei,void 0);var fi=B("ytPubsub2Pubsub2SubscribedKeys")||{};A("ytPubsub2Pubsub2SubscribedKeys",fi,void 0);var gi=B("ytPubsub2Pubsub2TopicToKeys")||{};A("ytPubsub2Pubsub2TopicToKeys",gi,void 0);var hi=B("ytPubsub2Pubsub2IsAsync")||{};A("ytPubsub2Pubsub2IsAsync",hi,void 0);
A("ytPubsub2Pubsub2SkipSubKey",null,void 0);function ii(a,b){var c=ji();c&&c.publish.call(c,a.toString(),a,b)}
...
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new Q("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",Cm:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
...
function Yi(a,b,c,d){return I(a,function f(){var g=this,h,k,l,n,q,r,p,z,G,H,R,V;return x(f,function(K){switch(K.h){case 1:var U={mode:"readonly",J:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?U.mode=c:Object.assign(U,c);h=U;g.transactionCount++;k=h.J?3:1;l=0;case 2:if(n){K.u(3);break}l++;q=Math.round(P());ra(K,4);r=g.h.transaction(b,h.mode);U=new bj(r);U=cj(U,d);return w(K,U,6);case 6:return p=K.i,z=Math.round(P()),dj(g,q,z,l,void 0,b.join(),h),K.return(p);case 4:G=sa(K);H=Math.round(P());
R=Ki(G,g.h.name,b.join(),g.h.version);if((V=R instanceof Q&&!R.h)||l>=k)dj(g,q,H,l,R,b.join(),h),n=R;K.u(2);break;case 3:return K.return(Promise.reject(n))}})})}
...
function nj(a,b){b=void 0===b?{}:b;return I(this,function d(){var e,f,g;return x(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
return w(h,Ui(e),0)})})}
...
oj.prototype.open=function(){function a(){return I(c,function g(){var h=this,k,l,n,q,r;return x(g,function(p){switch(p.h){case 1:return ra(p,2),w(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var z=h.options;for(var G=u(Object.keys(z.va)),H=G.next();!H.done;H=G.next()){H=H.value;var R=z.va[H],V=void 0===R.Jb?Number.MAX_VALUE:R.Jb;if(k.h.version>=R.Aa&&!(k.h.version>=V)&&!k.h.objectStoreNames.contains(H)){z=H;break a}}z=void 0}l=z;if(void 0===l){p.u(5);break}if(h.j){p.u(6);break}h.j=!0;return w(p,
...
function rj(a){return I(this,function c(){var d;return x(c,function(e){if(1==e.h)return w(e,qj.open(),2);d=e.i;return e.return(Yi(d,["databases"],{J:!0,mode:"readwrite"},function(f){var g=f.objectStore("databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier:1)return Vi(g.h.put(a,void 0)).then(function(){})})}))})})}
function sj(a){return I(this,function c(){var d;return x(c,function(e){if(1==e.h)return a?w(e,qj.open(),2):e.return();d=e.i;return e.return(d.delete("databases",a))})})}
function tj(a){return I(this,function c(){var d,e;return x(c,function(f){return 1==f.h?(d=[],w(f,qj.open(),2)):3!=f.h?(e=f.i,w(f,Yi(e,["databases"],{J:!0,mode:"readonly"},function(g){d.length=0;return gj(g.objectStore("databases"),{},function(h){a(h.getValue())&&d.push(h.getValue());return h.continue()})}),3)):f.return(d)})})}
...
function Bj(a,b,c,d){return I(this,function f(){var g,h,k,l;return x(f,function(n){switch(n.h){case 1:return w(n,zj(),2);case 2:g=n.i;if(!g)throw h=Li("openDbImpl",a,b),ui(h),h;zi(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:Aj(a);ra(n,3);return w(n,rj(k),5);case 5:return w(n,mj(k.actualName,b,d),6);case 6:return n.return(n.i);case 3:return l=sa(n),ra(n,7),w(n,sj(k.actualName),9);case 9:n.h=8;n.m=0;break;case 7:sa(n);case 8:throw l;}})})}
function Cj(a,b,c){c=void 0===c?{}:c;return Bj(a,b,!1,c)}
function Dj(a,b,c){c=void 0===c?{}:c;return Bj(a,b,!0,c)}
function Ej(a,b){b=void 0===b?{}:b;return I(this,function d(){var e,f;return x(d,function(g){if(1==g.h)return w(g,zj(),2);if(3!=g.h){e=g.i;if(!e)return g.return();zi(a);f=Aj(a);return w(g,nj(f.actualName,b),3)}return w(g,sj(f.actualName),0)})})}
function Fj(a,b){var c=this;a=a.map(function(d){return I(c,function f(){return x(f,function(g){return 1==g.h?w(g,nj(d.actualName,b),2):w(g,sj(d.actualName),0)})})});
return Promise.all(a).then(function(){})}
function Gj(){var a=void 0===a?{}:a;return I(this,function c(){var d,e;return x(c,function(f){if(1==f.h)return w(f,zj(),2);if(3!=f.h){d=f.i;if(!d)return f.return();zi("LogsDatabaseV2");return w(f,uj(),3)}e=f.i;return w(f,Fj(e,a),0)})})}
function Hj(a,b){b=void 0===b?{}:b;return I(this,function d(){var e;return x(d,function(f){if(1==f.h)return w(f,zj(),2);if(3!=f.h){e=f.i;if(!e)return f.return();zi(a);return w(f,nj(a,b),3)}return w(f,sj(a),0)})})}
...
v(T,Je);function fk(){if(!T.h){var a=B("yt.networkStatusManager.instance")||new T;A("yt.networkStatusManager.instance",a,void 0);T.h=a}return T.h}
m=T.prototype;m.G=function(){return this.j};
m.Y=function(a,b){a!==this.j&&((void 0===b?0:b)?this.N():this.j=a)};
...
function ek(a){window.addEventListener("online",function(){return I(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return w(e,d.N(),2);if(d.I&&O("offline_error_handling")){var f=ak().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new wi(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;Mf(h)}ak().set("errors",{},2592E3,!0)}}e.h=0})})})}
function dk(a){window.addEventListener("offline",function(){return I(a,function c(){var d=this;return x(c,function(e){return w(e,d.N(),0)})})})}
function gk(a){a.C=gg(function(){return I(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.j?d.Ea()||!d.l?e.u(3):w(e,d.N(),3):w(e,d.N(),3);gk(d);e.h=0})})},ck)}
...
b=void 0===b?{}:b;O("skip_is_supported_killswitch")?zj().then(function(d){c(d)}):c(zk())}
function sk(){var a=this,b=zk();if(!b)throw Li("throttleSend");lk||(lk=ig(function(){return I(a,function d(){var e;return x(d,function(f){if(1==f.h)return w(f,Pj("NEW",b),2);if(3!=f.h)return e=f.i,e?w(f,yk(e),3):(tk(),f.return());lk&&(lk=0,sk());f.h=0})})},100))}
function tk(){lg(lk);lk=0}
function yk(a){return I(this,function c(){var d,e,f;return x(c,function(g){switch(g.h){case 1:d=zk();if(!d)throw e=Li("immediateSend"),e;if(void 0===a.id){g.u(2);break}return w(g,Qj(a.id,d),3);case 3:(f=g.i)?a=f:Nf(Error("The request cannot be found in the database."));case 2:if(Bk(a,2592E6)){g.u(4);break}Nf(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){g.u(5);break}return w(g,Sj(a.id,d),5);case 5:return g.return();case 4:a.skipRetry||(a=Ck(a));var h=a,k,l;
...
a.options.onError=function(f,g){return I(b,function k(){return x(k,function(l){switch(l.h){case 1:if(!((B("ytNetworklessLoggingInitializationOptions")?ok.potentialEsfErrorCounter:mk)<=Rf("potential_esf_error_limit",10))){l.u(2);break}return w(l,rk().N(),3);case 3:if(rk().G())B("ytNetworklessLoggingInitializationOptions")&&ok.potentialEsfErrorCounter++,mk++;else return d(f,g),l.return();case 2:if(void 0===(null===a||void 0===a?void 0:a.id)){l.u(4);break}return 1>a.sendCount?w(l,Rj(a.id,c),8):w(l,Sj(a.id,
c),4);case 8:ig(function(){rk().G()&&sk()},5E3);
case 4:d(f,g),l.h=0}})})};
var e=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(f,g){return I(b,function k(){return x(k,function(l){if(1==l.h)return void 0===(null===a||void 0===a?void 0:a.id)?l.u(2):w(l,Sj(a.id,c),2);O("vss_network_hint")&&rk().Y(!0);e(f,g);l.h=0})})};
return a}
function Bk(a,b){a=a.timestamp;return P()-a>=b?!1:!0}
function qk(){var a=this,b=zk();if(!b)throw Li("retryQueuedRequests");Pj("QUEUED",b).then(function(c){c&&!Bk(c,12E4)?ig(function(){return I(a,function e(){return x(e,function(f){if(1==f.h)return void 0===c.id?f.u(2):w(f,Rj(c.id,b),2);qk();f.h=0})})}):rk().G()&&sk()})}
function uk(){return I(this,function b(){var c,d;return x(b,function(e){c=zk();if(!c)throw d=Li("clearSWHealthLogsDb"),d;return e.return(Yj().catch(function(f){Mf(f)}))})})}
...
a.H;this.P=a.P;this.Ka=a.Ka;this.Ja=a.Ja;this.databaseToken&&(!this.K||this.K("networkless_logging"))&&Ek(this)}
function Ek(a){I(a,function c(){var d=this;return x(c,function(e){if(!d.databaseToken)return e.return();Fk(d);d.H.G()&&d.ka();d.H.W(d.Ka,d.ka.bind(d));d.H.W(d.Ja,d.Qa.bind(d));d.h=!0;return d.sa&&Math.random()<=d.qa?w(e,d.F.pb(d.databaseToken),0):e.u(0)})})}
...
b.onError=function(g,h){return I(d,function l(){var n=this,q;return x(l,function(r){if(1==r.h)return q=n,w(r,n.F.set(e,n.databaseToken).catch(function(p){Hk(q,p)}),2);
f(g,h);r.h=0})})}}this.P(a,b,e.skipRetry)}else this.F.set(e,this.databaseToken).catch(function(g){d.P(a,b,e.skipRetry);
Hk(d,g)})}else this.P(a,b,this.K&&this.K("nwl_skip_retry")&&c)};
...
d.options.onSuccess=function(g,h){void 0!==d.id?c.F.ga(d.id,c.databaseToken):e=!0;c.H.Y&&c.K&&c.K("vss_network_hint")&&c.H.Y(!0);f(g,h)};
this.P(d.url,d.options);this.F.set(d,this.databaseToken).then(function(g){d.id=g;e&&c.F.ga(d.id,c.databaseToken)}).catch(function(g){Hk(c,g)})}else this.P(a,b)};
m.ka=function(){var a=this;if(!this.databaseToken)throw Li("throttleSend");this.i||(this.i=ig(function(){return I(a,function c(){var d=this,e;return x(c,function(f){if(1==f.h)return w(f,d.F.Wa("NEW",d.databaseToken),2);if(3!=f.h)return e=f.i,e?w(f,Gk(d,e),3):(d.Qa(),f.return());d.i&&(d.i=0,d.ka());f.h=0})})},this.kb))};
m.Qa=function(){lg(this.i);this.i=0};
function Gk(a,b){return I(a,function d(){var e=this,f,g;return x(d,function(h){switch(h.h){case 1:if(!e.databaseToken)throw f=Li("immediateSend"),f;if(void 0===b.id){h.u(2);break}return w(h,e.F.Cb(b.id,e.databaseToken),3);case 3:(g=h.i)?b=g:e.ha(Error("The request cannot be found in the database."));case 2:if(Ik(e,b,e.fb)){h.u(4);break}e.ha(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){h.u(5);break}return w(h,e.F.ga(b.id,e.databaseToken),5);case 5:return h.return();
case 4:b.skipRetry||(b=Jk(e,b));if(!b){h.u(0);break}if(!b.skipRetry||void 0===b.id){h.u(8);break}return w(h,e.F.ga(b.id,e.databaseToken),8);case 8:e.P(b.url,b.options,!!b.skipRetry),h.h=0}})})}
function Jk(a,b){if(!a.databaseToken)throw Li("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){return I(a,function h(){var k=this,l;return x(h,function(n){switch(n.h){case 1:l=k;if(!(k.potentialEsfErrorCounter<=k.La)){n.u(2);break}if(!k.H.N){n.u(3);break}return w(n,k.H.N(),3);case 3:if(k.H.G())k.potentialEsfErrorCounter++;else return c(e,f),n.return();case 2:if(void 0===(null===b||void 0===b?void 0:b.id)){n.u(5);break}return b.sendCount<k.ib?w(n,k.F.gb(b.id,k.databaseToken),9):w(n,k.F.ga(b.id,k.databaseToken),5);case 9:ig(function(){l.H.G()&&l.ka()},k.hb);
case 5:c(e,f),n.h=0}})})};
var d=b.options.onSuccess?b.options.onSuccess:function(){};
b.options.onSuccess=function(e,f){return I(a,function h(){var k=this;return x(h,function(l){if(1==l.h)return void 0===(null===b||void 0===b?void 0:b.id)?l.u(2):w(l,k.F.ga(b.id,k.databaseToken),2);k.H.Y&&k.K&&k.K("vss_network_hint")&&k.H.Y(!0);d(e,f);l.h=0})})};
return b}
function Ik(a,b,c){b=b.timestamp;return a.now()-b>=c?!1:!0}
function Fk(a){if(!a.databaseToken)throw Li("retryQueuedRequests");a.F.Wa("QUEUED",a.databaseToken).then(function(b){b&&!Ik(a,b,a.cb)?ig(function(){return I(a,function d(){var e=this;return x(d,function(f){if(1==f.h)return void 0===b.id?f.u(2):w(f,e.F.gb(b.id,e.databaseToken),2);Fk(e);f.h=0})})}):a.H.G()&&a.ka()})}
function Hk(a,b){a.lb&&!a.H.G()?a.lb(b):a.handleError(b)}
;function Kk(){Dk.call(this,{F:{pb:Tj,ga:Sj,Wa:Pj,Cb:Qj,gb:Rj,set:Nj},H:new hk({Za:!0,Ua:!0}),handleError:Mf,ha:Nf,P:Lk,now:P,lb:bk,Ya:kg(),Ka:"publicytnetworkstatus-online",Ja:"publicytnetworkstatus-offline",sa:!0,qa:.1,La:Rf("potential_esf_error_limit",10),K:O});this.sa&&Math.random()<=this.qa&&this.databaseToken&&Xj();O("networkless_immediately_drop_sw_health_store")&&Mk(this);O("networkless_immediately_drop_all_requests")&&Uj();Hj("LogsDatabaseV2")}
v(Kk,Dk);function Nk(){var a=B("yt.networklessRequestController.instance");a||(a=new Kk,A("yt.networklessRequestController.instance",a,void 0),O("networkless_logging")&&zj().then(function(b){a.databaseToken=b;Ek(a)}));
return a}
...
function Mk(a){I(a,function c(){var d=this,e,f;return x(c,function(g){e=d;if(!d.databaseToken)throw f=Li("clearSWHealthLogsDb"),f;return g.return(Yj().catch(function(h){e.handleError(h)}))})})}
...
function Hh(a,b,c,d){function e(r){r=void 0===r?!1:r;var p;if(d.retry&&"www.youtube-nocookie.com"!=h&&(r||O("skip_ls_gel_retry")||(p=$h(b,c,l,k)),p)){var z=g.onSuccess,G=g.onFetchSuccess;g.onSuccess=function(H,R){ai(p);z(H,R)};
c.onFetchSuccess=function(H,R){ai(p);G(H,R)}}try{r&&d.retry&&!d.bb.bypassNetworkless?(g.method="POST",d.bb.writeThenSend?O("use_new_nwl")?Nk().writeThenSend(q,g):vk(q,g):O("use_new_nwl")?Nk().sendAndWrite(q,g):Ak(q,g)):(g.method="POST",g.postParams||(g.postParams={}),Og(q,g))}catch(H){if("InvalidAccessError"==H.name)p&&(ai(p),p=0),Nf(Error("An extension is blocking network request."));
else throw H;}p&&gg(function(){bi(a)},5E3)}
...
wa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Sk={X:[],T:[{Pa:Rk,weight:500}]};function Rk(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
...
Vk();c=u(a.X);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Bm)){a=d.weight;break a}a=u(a.T);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Pa(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Qk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.wa[l.name])for(e=u(c.wa[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
...
Ri:101951,Si:97346,Ti:118051,Ui:95102,Vi:64882,Wi:119505,Xi:63595,Yi:63349,Zi:95101,aj:75240,bj:27039,cj:68823,dj:21537,ej:83464,fj:75707,gj:83113,hj:101952,ij:101953,kj:79610,lj:125755,mj:24402,nj:24400,oj:32925,pj:57173,qj:122502,rj:64423,sj:64424,tj:33986,uj:100828,vj:129089,wj:21409,Aj:135155,Bj:135156,Cj:135157,Dj:135158,Ej:135159,Fj:135160,Gj:135161,Hj:135162,Ij:135163,Jj:135164,Kj:135165,Lj:135166,xj:11070,yj:11074,zj:17880,Mj:14001,Oj:30709,Pj:30707,Qj:30711,Rj:30710,Sj:30708,Nj:26984,Tj:63648,
Uj:63649,Vj:51879,Wj:111059,Xj:5754,Yj:20445,ak:130975,Zj:130976,bk:110386,ck:113746,dk:66557,ek:17310,fk:28631,gk:21589,hk:68012,ik:60480,jk:31571,kk:76980,lk:41577,mk:45469,nk:38669,pk:13768,qk:13777,rk:62985,sk:4724,tk:59369,uk:43927,vk:43928,wk:12924,xk:100355,Ak:56219,Bk:27669,Ck:10337,zk:47896,Dk:122629,Ek:121258,Fk:107598,Gk:127991,Hk:96639,Ik:107536,Jk:130169,Kk:96661,Lk:96658,Mk:116646,Nk:121122,Ok:96660,Pk:127738,Qk:127083,Rk:104443,Sk:96659,Tk:106442,Uk:134840,Vk:63667,Wk:63668,Xk:63669,
Yk:130686,Zk:78314,al:55761,bl:127098,dl:134841,fl:96368,il:67374,jl:48992,kl:49956,ll:31961,ml:26388,nl:23811,ol:5E4,pl:126250,ql:96370,rl:47355,sl:47356,ul:37935,vl:45521,wl:21760,xl:83769,yl:49977,zl:49974,Al:93497,Bl:93498,Cl:34325,Dl:115803,El:123707,Fl:100081,Gl:35309,Hl:68314,Il:25602,Jl:100339,Kl:59018,Ll:18248,Ml:50625,Nl:9729,Ol:37168,Pl:37169,Ql:21667,Rl:16749,Sl:18635,Tl:39305,Ul:18046,Vl:53969,Wl:8213,Xl:93926,Yl:102852,Zl:110099,am:22678,bm:69076,dm:100856,em:17736,fm:3832,gm:55759,
hm:64031,im:93044,jm:93045,km:34388,lm:17657,mm:17655,nm:39579,om:39578,pm:77448,qm:8196,rm:11357,sm:69877,tm:8197,um:82039};function ll(){var a=kb(ml),b;return bf(new Ve(function(c,d){a.onSuccess=function(e){Ig(e)?c(new nl(e)):d(new ol("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
return a.join("")}
;var Dl,El=y.ytLoggingDocDocumentNonce_;El||(El=Cl(),Ra("ytLoggingDocDocumentNonce_",El));Dl=El;var Fl={kf:0,Ic:1,Qc:2,ti:3,mf:4,cm:5,jj:6,yk:7,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE"};function Gl(a){this.h=a}
...
A("yt_logging_screen.getRootVeType",Kl,void 0);function Ll(a){return(a=Kl(void 0===a?0:a))?new Gl({veType:a,youtubeData:void 0}):null}
...
A("yt_logging_screen.getCurrentCsn",Nl,void 0);function Ol(a,b,c){var d=Ml();(c=Nl(c))&&delete d[c];b&&(d[a]=b)}
function Pl(a){return Ml()[a]}
A("yt_logging_screen.getCttAuthInfo",Pl,void 0);function Ql(a,b,c,d){c=void 0===c?0:c;if(a!==E(Il(c))||b!==E(Jl(c)))Ol(a,d,c),N(Il(c),a),N(Jl(c),b),b=function(){setTimeout(function(){a&&Jh("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Dl,clientScreenNonce:a},Ok)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
A("yt_logging_screen.setCurrentScreen",Ql,void 0);function Rl(a){ci.call(this,1,arguments);this.csn=a}
...
;function vm(){var a=B("ytcsi.debug");a||(a=[],A("ytcsi.debug",a,void 0),A("ytcsi.reference",{},void 0));return a}
...
;var xm=y.ytLoggingLatencyUsageStats_||{};A("ytLoggingLatencyUsageStats_",xm,void 0);function ym(){this.h=0}
...
function Xm(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Gb?c.Gb:c.layer;var e=Nl(d);d=Ll(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=E("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=a.client;h=f;var l=c.Sa,n=c.cttAuthInfo,q=c.zm,r=Ul(),p={csn:r,pageVe:(new Gl({veType:b,youtubeData:g})).getAsJson()};h&&h.visualElement?(p.implicitGesture=
{parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()},q&&(p.implicitGesture.gestureType=q)):h&&hl(new wi("newScreen() parent element does not have a VE - rootVe",b));l&&(p.cloneCsn=l);l={cttAuthInfo:n,Z:r};k?Jh("screenCreated",p,k,l):Pk("screenCreated",p,l);ii(li,new Rl(r));var z=r}catch(G){jl(G,{Em:b,rootVe:d,parentVisualElement:void 0,ym:e,Dm:f,Sa:c.Sa});il(G);return}Ql(z,b,c.layer,c.cttAuthInfo);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=O("screen_manager_skip_hide_killswitch"))){a:{b=
u(Object.values(Fl));for(f=b.next();!f.done;f=b.next())if(Nl(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,k=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:k},f={cttAuthInfo:Pl(e),Z:e,tb:f},"UNDEFINED_CSN"==e?Xl("visualElementHidden",d,f):b?Jh("visualElementHidden",d,b,f):Pk("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=z||"");Mm("csn",z);Yl.getInstance().clear();d=Ll(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(O("web_mark_root_visible")||
O("music_web_mark_root_visible"))&&(e=z,z={csn:e,ve:d.getAsJson(),eventType:1},b={cttAuthInfo:Pl(e),Z:e},"UNDEFINED_CSN"==e?Xl("visualElementShown",z,b):Pk("visualElementShown",z,b));a.i.delete(c.layer||0);a.j=void 0;e=u(a.B);for(z=e.next();!z.done;z=e.next())b=u(z.value),z=b.next().value,b=b.next().value,b.has(c.layer)&&d&&Vm(a,z,d,c.layer);for(c=0;c<a.l.length;c++){e=a.l[c];try{e()}catch(G){il(G)}}for(c=a.l.length=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(G){il(G)}}}
...
v(Yn,Xn);function Zn(a,b,c,d){L.call(this);var e=this;this.I=b;this.webPlayerContextConfig=d;this.ya=!1;this.api={};this.fa=this.m=null;this.L=new M;this.i={};this.S=this.la=this.elementId=this.za=this.config=null;this.R=!1;this.l=this.B=null;this.ma={};this.mb=["onReady"];this.lastError=null;this.Oa=NaN;this.C={};this.nb=new Yn(this);this.ea=0;this.j=this.o=a;Ud(this,Qa(Sd,this.L));$n(this);ao(this);Ud(this,Qa(Sd,this.nb));c?this.ea=cg(function(){e.loadNewVideoConfig(c)},0):d&&(bo(this),co(this))}
...
function co(a){if(!a.h&&!a.R){var b=ho(a);if(b&&"html5"===(io(a)?"html5":null))a.S="html5",a.isReady()||ko(a);else if(lo(a),a.S="html5",b&&a.l&&a.o)a.o.appendChild(a.l),ko(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.B=function(){c=!0;var d=mo(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?fo(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);ko(a)};
a.R=!0;b?a.B():(dn(jo(a),a.B),(b=no(a))&&Tn(b),oo(a)&&!c&&A("yt.player.Application.create",null,void 0))}}}
function io(a){var b=Rc(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function ko(a){var b;if(!a.h){var c=io(a),d=!1;c&&c.getApiInterface&&c.getApiInterface()&&(d=!0);d?(a.R=!1,!mo(a,"html5_remove_not_servable_check_killswitch")&&(null===c||void 0===c?0:c.isNotServable)&&a.config&&(null===c||void 0===c?0:c.isNotServable(null===(b=a.config.args)||void 0===b?void 0:b.video_id))||po(a)):a.Oa=cg(function(){ko(a)},50)}}
...
hb(a.C,String(e))};
return c}
m.getPlayerType=function(){return this.S||(io(this)?"html5":null)};
m.getLastError=function(){return this.lastError};
function lo(a){a.cancel();$n(a);a.S=null;a.config&&(a.config.loaded=!1);var b=io(a);b&&(ho(a)||!oo(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.B&&kn(jo(this),this.B);dg(this.Oa);this.R=!1};
...
;A("yt.setConfig",N,void 0);A("yt.config.set",N,void 0);A("yt.setMsg",Pf,void 0);A("yt.msgs.set",Pf,void 0);A("yt.logging.errors.log",il,void 0);
A("writeEmbed",function(){var a=E("PLAYER_CONFIG",void 0);if(!a){var b=E("PLAYER_VARS",void 0);b&&(a={args:b})}Al(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=E("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);O("embeds_js_api_set_1p_cookie")&&(c=Bg(),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));N("FORCE_CSI_ON_GEL",!0);
